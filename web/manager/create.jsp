...
<t:genericPage>
    ...
    <jsp:body>
        <div class="container" style="min-height: 500px;background-image: url('http://www.xiuren.org/xiuren2/XiuRen-N01867/0036.jpg');background-size: cover;background-position: top">
            <form method="post">
